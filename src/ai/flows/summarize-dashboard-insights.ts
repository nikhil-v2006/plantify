...
export async function summarizeDashboardInsights(input: SummarizeDashboardInsightsInput): Promise<SummarizeDashboardInsightsOutput> {
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following information about the current status of the farm:
